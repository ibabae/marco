...
<div class="row">
    ...
    <div class="col-12">
        <form class="row" action="{{route('page.edit.store',['id'=>$page->id])}}" method="POST" enctype="multipart/form-data">
            @csrf
                            ...
                            <section class="content-body p-xl-4">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-4 col-9">
                                        <input type="text" name="Title" class="form-control" id="Title" required value="@if(old('Title') != null){{old('Title')}}@else{{$page->Title}}@endif" placeholder="">
                                        @error('Title')
                                    ...
                                    <div class="col-lg-4 col-9 mb-4">
                                        <input type="text" name="Slug" class="form-control" id="Slug" value="@if(old('Slug') != null){{old('Slug')}}@else{{$page->Slug}}@endif" placeholder="">
                                        @error('Slug')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div> <!-- row.// -->
                                ...
                                <textarea id="editor" name="Content">@if(old('Content') != null){{old('Content')}}@else{{$page->Content}}@endif</textarea>
                                @error('Content')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-9">
                                        <label class="form-check my-2">
                                            <input type="checkbox" name="Status" class="form-check-input" @if($page->Status == 1)checked=""@endif>
