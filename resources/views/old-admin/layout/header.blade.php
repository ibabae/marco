<header class="main-header navbar">
    <div class="col-search">
        <form class="searchform" action="{{route('old.product.search')}}" method="GET">
            @csrf
        ...
        <ul class="nav">
            ...
            <li class="dropdown nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-start" aria-labelledby="dropdownAccount">
                    <a class="dropdown-item" href="{{route('old.settings')}}"><i class="material-icons md-settings"></i>تنظیمات</a>
