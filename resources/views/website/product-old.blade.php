                            ...
                            <div class="detail-info">
                                ...
                                <div class="product-detail-rating">
                                    ...
                                    <div class="product-rate-cover text-end">
                                        ...
                                        <span class="font-small ms-5 text-muted"> (0 دیدگاه)</span>
                                    </div>
                                </div>
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        @if($product->DisAmount != NULL)
                                            ...
                                            <ins><span class="old-price font-md ms-15">{{price($product->Price)}}</span></ins>
                                            <span class="save-price  font-md color3 ms-15"> @if($product->DisType == 1) {{price($product->DisAmount)}} @else %{{$product->DisAmount}} @endif تخفیف</span>
                                        @else
                                                    ...
                                                    <div class="desc">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                <p class="font-xs me-30">28 مرداد 1401 ساعت 11:30</p>
                                            ...
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    ...
                                                    <div class="desc">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                <p class="font-xs me-30">25 مرداد 1401 ساعت 18:47 </p>
                                                                <a href="#" class="text-brand btn-reply">پاسخ <i class="fi-rs-arrow-left"></i> </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="single-comment justify-content-between d-flex">
                                                <div class="user justify-content-between d-flex">
                                                    ...
                                                    <div class="desc">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                <p class="font-xs me-30">20 مرداد 1401 ساعت 14:18 </p>
                                                                <a href="#" class="text-brand btn-reply">پاسخ <i class="fi-rs-arrow-left"></i> </a>
                                                            </div>
                                                        </div>
                                                    </div>
