...
<!-- Mirrored from roti-preview.taymakz.ir/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2024 09:55:06 GMT -->
...
<head>
  ...
  <body>
    ...
    <div class="flex min-h-screen flex-col">
      <header>
        <!-- Header -->
        <div class="fixed left-0 right-0 top-0 z-30 bg-white dark:bg-zinc-900">
          <!-- Header Desktop -->
          <div>
            <div class="hidden md:block">
              <!-- Top Section -->
              <div
                class="container relative z-30 flex max-w-[1680px] items-center justify-between gap-x-4 bg-white py-4 dark:bg-zinc-900"
              >
                <!-- logo -->
                <div>
                  <a href='index.html'>
                ...
                >
                  <div
                    ...
                    class="flex items-center justify-between rounded-lg border-gray-200 border-b-transparent bg-gray-100 px-2 dark:border-white/10 dark:border-b-transparent dark:bg-black"
                  >
                    <div>
                      <svg class="h-6 w-6 text-zinc-700 dark:text-white">
                    ...
                    <input
                      ...
                      class="flex grow rounded-lg border-none bg-gray-100 px-2 py-3 text-zinc-600 outline-none placeholder:text-sm placeholder:text-zinc-500 focus:ring-0 dark:bg-black dark:text-zinc-300 placeholder:dark:text-zinc-400"
                  ...
                  <div
                    ...
                    class="absolute inset-x-0 top-full hidden w-full overflow-hidden rounded-b-lg border border-gray-200 border-t-transparent bg-white dark:border-white/10 dark:border-t-transparent dark:bg-zinc-900"
                  >
                    <div class="max-h-[450px] overflow-y-auto py-5">
                      ...
                      <div class="space-y-6">
                        ...
                        <div class="px-5">
                          <div
                            class="mb-4 flex items-center gap-x-2 text-zinc-600 dark:text-zinc-300"
                          >
                            <svg class="h-6 w-6">
                          ...
                          <div class="swiper search-result-desktop h-14">
                            <div class="swiper-wrapper">
                              <div class="swiper-slide">
                                <a
                                  href="#"
                                  class="flex items-center justify-center gap-x-2 rounded-full border border-gray-100 p-2 text-zinc-500 hover:border-gray-200 dark:border-white/5 dark:text-zinc-400 hover:dark:border-white/10"
                                >
                                  <p class="line-clamp-1">کفش نایک</p>
                                  <svg class="h-4 w-4">
                ...
                <div class="flex gap-x-4">
                  ...
                  <div>
                    ...
                    <div
                      class="z-10 !ml-5 hidden w-60 overflow-hidden rounded-lg border-t-2 border-t-emerald-500 bg-white dark:border-t-emerald-400 dark:bg-zinc-900"
                      id="dropdownAccountDesktop"
                    >
                      <ul class="space-y-1 p-2">
                        <li>
                          <a class='flex items-center justify-between gap-x-2 rounded-lg p-4 text-zinc-700 hover:text-emerald-500 dark:text-white dark:hover:text-emerald-400' href='profile-dashboard.html'>
                            <span class="flex items-center gap-x-4">
                              ...
                              <span class="line-clamp-1"> نام تستی تستی </span>
                            </span>
                            <span>
                              <svg class="h-6 w-6">
                                <use xlink:href="#chevron-left" />
                        ...
                        <li>
                          <a
                            class="flex items-center justify-between rounded-lg p-4 text-zinc-700 hover:text-emerald-500 dark:text-white dark:hover:text-emerald-400"
                        ...
                        <li>
                          ...
                          >
                            ...
                            <span class="relative flex h-5 w-5">
                              ...
                              ></span>
                              <span
                                class="relative inline-flex h-5 w-5 items-center justify-center rounded-full bg-emerald-500 text-sm text-white dark:text-white"
                                >2</span
                              >
                            </span>
                          </a>
                        ...
                        <li>
                          <div
                            class="my-2 h-px w-full rounded-full bg-gray-100 dark:bg-white/5"
                          ></div>
                        </li>
                        <li>
                          <a
                    ...
                    <!-- <a href="./login.html">
                      <div
                        class="flex h-8 cursor-pointer items-center justify-center rounded-lg border border-gray-100 px-4 text-sm font-medium text-zinc-700 transition-colors duration-200 hover:bg-emerald-500 hover:text-white dark:border-white/5 dark:text-white dark:hover:bg-emerald-500 dark:hover:text-white"
                      >
                        ورود \ ثبت نام
                      </div>
                    </a> -->
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span
                        class="absolute -right-2.5 -top-2.5 flex h-5 w-5 cursor-pointer items-center justify-center rounded-full bg-emerald-500 text-sm font-bold text-white"
                      >
                        10
                      </span>
                    </button>
                    ...
                    >
                      ...
                      <div class="flex items-center justify-between p-5 pb-2">
                        ...
                        <a class='flex items-center gap-x-1 text-sm text-emerald-500 dark:text-emerald-400' href='checkout-cart.html'>
                          ...
                          <li>
                            <div class="flex gap-x-2 py-5">
                              ...
                              <div class="w-full space-y-1.5">
                                ...
                                <a class='line-clamp-2 h-12 text-zinc-700 dark:text-white' href='product-detail.html'>
                                  تیشرت اسپورت مردانه
                                </a>
                                <!-- Product Attribute -->
                                <div
              ...
              <!-- Bottom Section -->
              <div
                class="absolute left-0 right-0 top-full z-20 bg-white shadow-sm transition-transform duration-300 dark:bg-zinc-900"
              ...
              >
                ...
                >
                  <ul class="group z-10" id="desktopMegamenuWrapper">
                    <div
                      class="relative flex cursor-pointer items-center gap-x-2 pb-2 text-zinc-700 dark:text-white"
                    >
                      <div>
                        <svg class="h-5 w-5">
                    ...
                    <div class="absolute top-full w-full max-w-[1000px]">
                      <div
                        class="relative hidden rounded-b-lg bg-white shadow-base dark:bg-zinc-900"
                        id="desktopMegamenu"
                      >
                        <div
                        ...
                        >
                          <!-- Right side -->
                          <div
                            class="main-scroll w-50 overflow-y-auto border-gray-100 bg-gray-100 dark:border-white/5 dark:bg-black"
                            dir="ltr"
                          >
                            <ul dir="rtl" id="mega-menu-parents">
                              <li>
                                <a class='flex py-4 pr-4 text-zinc-700 dark:text-white' data-category-parent='1' href='shop.html'>
                                  مردانه
                                </a>
                              </li>
                              <li>
                                <a class='flex py-4 pr-4 text-zinc-700 dark:text-white' data-category-parent='2' href='shop.html'>
                                  زنانه
                                </a>
                              </li>
                              <li>
                                <a class='flex py-4 pr-4 text-zinc-700 dark:text-white' data-category-parent='3' href='shop.html'>
                                  بچه گانه
                                </a>
                              </li>
                              <li>
                                <a class='flex py-4 pr-4 text-zinc-700 dark:text-white' data-category-parent='4' href='shop.html'>
                                  ساعت
                                </a>
                              </li>
                              <li>
                                <a class='flex py-4 pr-4 text-zinc-700 dark:text-white' data-category-parent='5' href='shop.html'>
                                  کیف
                                </a>
                              </li>
                              <li>
                                <a class='flex py-4 pr-4 text-zinc-700 dark:text-white' data-category-parent='6' href='shop.html'>
                                  آرایشی و بهداشتی
                                </a>
                              </li>
                              <li>
                                <a class='flex py-4 pr-4 text-zinc-700 dark:text-white' data-category-parent='7' href='shop.html'>
                                  عطر و ادکلن
                                </a>
                              </li>
                            </ul>
                          ...
                          >
                            ...
                            >
                              ...
                              <div class="hidden p-5" data-category-child="1">
                                <!-- head -->
                                <div class="mb-4">
                                  <a class='flex items-center gap-x-1 py-2 text-sm text-emerald-500 dark:text-emerald-400' href='shop.html'>
                                    <div>مشاهده همه</div>
                                    <svg class="h-5 w-5">
                                ...
                                >
                                  <div class="space-y-2">
                                    <a class='flex items-center gap-x-2 text-zinc-700 hover:text-emerald-500 dark:text-white hover:dark:text-emerald-400' href='shop.html'>
                                      <span
                                        class="h-5 w-0.5 rounded-full bg-emerald-500 dark:bg-emerald-500"
                                      ></span>
                                      <div>لباس مردانه</div>
                                      <svg class="h-5 w-5">
                                        <use xlink:href="#chevron-left"></use>
                                    ...
                                    <ul>
                                      <li>
                                        <a class='block py-2 text-sm text-zinc-600 hover:text-emerald-500 dark:text-zinc-300 hover:dark:text-emerald-400' href='shop.html'>
                                          شلوار
                                        </a>
                                      </li>
                                      <li>
                  ...
                  <ul data-color-dark="#f87171" data-color-light="#ef4444">
                    <a class="group" href="special-sale.html">
                      <div class="p-2 pt-0 text-zinc-700 dark:text-white">
                        فروش ویژه
                      </div>
                    </a>
                  </ul>
                  <ul>
                    <a class="group" href="why-us.html">
                      <div class="p-2 pt-0 text-zinc-700 dark:text-white">
                        چرا روتی کالا
                      </div>
                    </a>
                  ...
                  <ul>
                    <a class="group" href="how-to-buy.html">
                      <div class="p-2 pt-0 text-zinc-700 dark:text-white">
                        راهنمای خرید
                      </div>
                    </a>
                  ...
                  <ul class="group relative z-10" id="header-desktop-indicator">
                    <div
                      class="flex cursor-pointer items-center gap-x-2 p-2 pt-0 text-zinc-700 dark:text-white"
                    >
                      سایر
                    ...
                    <div
                      class="absolute right-0 top-full hidden w-44 overflow-hidden rounded-b-lg bg-white group-hover:block dark:bg-zinc-900"
                    >
                      <ul class="space-y-1 p-2">
                        <li>
                          <a
                            class="hover:dark: flex rounded-lg px-4 py-3 text-zinc-700 hover:text-emerald-500 dark:text-white hover:dark:text-emerald-400"
                            href="contact.html"
                          >
                            تماس با ما
                          </a>
          ...
          <div>
            <div class="md:hidden">
              <!-- Top Section -->
              <div
                class="container relative z-30 flex h-16 items-center justify-between gap-x-4 bg-white dark:bg-zinc-900"
              >
                <!-- menu -->
                <button
                ...
                <div class="flex gap-x-4">
                  ...
                  <!-- <a href="./login.html">
                    <div
                      class="flex h-8 cursor-pointer items-center justify-center rounded-lg border border-gray-100 px-4 text-xs font-medium text-zinc-700 transition-colors duration-200 hover:bg-emerald-500 hover:text-white dark:border-white/5 dark:text-white dark:hover:bg-emerald-500 dark:hover:text-white xs:text-sm"
                    >
                      ورود \ ثبت نام
                    </div>
                  </a> -->
                  ...
                  <button
                    ...
                    type="button"
                  >
                    <span class="cursor-pointer text-zinc-700 dark:text-white">
                      <svg class="h-6 w-6">
                        <use xlink:href="#cart" />
                      </svg>
                    </span>
                    <span
                      class="absolute -right-2.5 -top-2.5 flex h-5 w-5 cursor-pointer items-center justify-center rounded-full bg-emerald-500 text-sm font-bold text-white dark:text-white"
                    >
                      10
                    </span>
                  </button>
              ...
              <!-- Bottom Section -->
              <div
                class="absolute left-0 right-0 top-full z-20 bg-white pb-4 transition-transform duration-300 dark:bg-zinc-900"
                  ...
                  <div class="relative" id="mobileHeaderSearchBase">
                    ...
                    >
                      ...
                      <input
                        ...
                        class="flex grow rounded-lg border-none bg-gray-100 px-2 py-3 text-zinc-700 outline-none placeholder:text-sm placeholder:text-zinc-500 focus:ring-0 dark:bg-black dark:text-white placeholder:dark:text-zinc-400"
                        placeholder="جستجو کنید ..."
                        type="text"
                      />
                    </div>
        ...
        <div
          class="fixed inset-0 z-20 hidden bg-black/40 backdrop-blur-md dark:bg-zinc-900/40"
          id="header-overlay"
        ></div>
      </header>
      ...
      <div>
        ...
        <div
          ...
          class="fixed right-0 top-0 z-40 h-full w-80 translate-x-full overflow-y-auto bg-white p-4 transition-transform duration-300 dark:bg-zinc-900"
          id="mobile-menu-drawer-navigation"
          tabindex="-1"
        >
          <div
            class="mb-6 flex items-center justify-between gap-x-4 border-b border-gray-100 pb-5 dark:border-white/5"
          >
            <!-- Logo -->
            <div>
              <a href='index.html'>
          ...
          <div class="mb-4">
            <div
              class="flex cursor-pointer items-center gap-x-2 rounded-lg px-4 py-3 text-emerald-500 dark:text-emerald-400"
          ...
          <div class="overflow-y-auto">
            <ul class="space-y-4">
              <li>
                <a class='flex items-center justify-between rounded-lg px-4 py-3 text-zinc-700 hover:text-emerald-500 dark:text-white hover:dark:text-emerald-400' href='index.html'>
                  <span class="flex items-center gap-x-2">
                    <svg class="h-6 w-6">
                      <use xlink:href="#home" />
                    </svg>
              ...
              <li>
                <a
                  class="flex items-center justify-between rounded-lg px-4 py-3 text-zinc-700 hover:text-emerald-500 dark:text-white hover:dark:text-emerald-400"
              ...
              <li>
                <div class="flex items-center">
                  <div
                    class="h-px w-full flex-grow rounded-full bg-gray-100 dark:bg-white/5"
                  ></div>

                  <div class="p-2 text-gray-300 dark:text-white/30">
                    <span class="flex items-center gap-x-2">
                      <svg class="h-6 w-6">
                        <use xlink:href="#order" />
                      </svg>
                  ...
                  <div class="space-y-2">
                    <h2 id="category-1">
                      <button
                        ...
                        aria-expanded="false"
                        class="flex w-full items-center justify-between rounded-lg px-4 py-3 text-zinc-700 dark:text-white"
                        data-accordion-target="#category-body-1"
                        type="button"
                      >
                        <span class="flex items-center"> مردانه </span>
                    ...
                    >
                      <ul class="mr-4 space-y-2">
                        <li>
                          <a class='flex w-full items-center justify-between rounded-lg px-4 py-3 text-zinc-700 dark:text-white' href='shop.html'>
                            <span class="flex items-center gap-x-2">
                            ...
                            <div class="space-y-2">
                              ...
                              >
                                <ul class="mr-4 space-y-2">
                                  ...
                                  <li>
                                    <a class='flex rounded-lg px-4 py-3 text-zinc-700 dark:text-white' href='shop.html'>
                                      <span class="line-clamp-1"> شلوارک </span>
                                    </a>
                                  </li>
                                  <li>
                                    <a class='flex rounded-lg px-4 py-3 text-zinc-700 dark:text-white' href='shop.html'>
                            ...
                            <div class="space-y-2">
                              ...
                              >
                                <ul class="mr-4 space-y-2">
                                  ...
                                  <li>
                                    <a class='flex rounded-lg px-4 py-3 text-zinc-700 dark:text-white' href='shop.html'>
                                      <span class="line-clamp-1"> اسپورت </span>
                                    </a>
                                  </li>
                                  <li>
                                    <a class='flex rounded-lg px-4 py-3 text-zinc-700 dark:text-white' href='shop.html'>
                                      <span class="line-clamp-1"> مجلسی </span>
                                    </a>
                                  </li>
                                </ul>
                              </div>
                  ...
                  <div class="space-y-2">
                    <h2 id="category-2">
                      <button
                        ...
                        type="button"
                      >
                        <span class="flex items-center"> زنانه </span>
        ...
        <div
          ...
          class="main-scroll fixed left-0 top-0 z-40 h-full w-80 -translate-x-full overflow-y-auto bg-white p-4 pb-20 transition-transform duration-300 dark:bg-zinc-900"
        ...
        >
          ...
          >
            ...
            <h5 class="text-lg text-zinc-700 dark:text-white">حساب کاربری</h5>
          </div>
          <div class="overflow-y-auto">
            <ul class="space-y-4">
              <li>
                <a class='flex items-center justify-between rounded-lg px-4 py-3 text-zinc-700 hover:text-emerald-500 dark:text-white hover:dark:text-emerald-400' href='profile-dashboard.html'>
                  <span class="flex items-center gap-x-4">
                    <span class="min-w-fit">
                      <img
                        alt=""
                    ...
                    <span class="line-clamp-1">تست تست تست تسستست تسست </span>
                  </span>
                  <span>
                    <svg class="h-6 w-6">
                      <use xlink:href="#chevron-left" />
              ...
              <li>
                ...
                >
                  ...
                  <span class="relative flex h-5 w-5">
                    ...
                    ></span>
                    <span
                      class="darktext-zinc-500 relative inline-flex h-5 w-5 items-center justify-center rounded-full bg-emerald-500 text-sm text-white dark:text-white"
                    >
                      2
                    </span>
                  </span>
              ...
              <li>
                <a
                  class="flex items-center justify-between rounded-lg px-4 py-3 text-red-500 hover:bg-red-500/10 dark:text-red-400 hover:dark:bg-red-400/10"
                  href="#"
                >
                  <div class="flex items-center gap-x-2">
                    <svg class="h-6 w-6">
        ...
        <div
          ...
          class="fixed left-0 top-0 z-40 h-full w-80 -translate-x-full bg-white transition-transform duration-300 dark:bg-zinc-900"
        ...
        >
          ...
          >
            ...
            <h5 class="text-lg text-zinc-600 dark:text-zinc-300">
              سبد خرید <span class="text-sm">( 4 )</span>
            </h5>
          </div>
              ...
              <li>
                <div class="flex gap-x-2 py-5">
                  ...
                  <div class="w-full space-y-1.5">
                    ...
                    <a class='line-clamp-2 h-10 text-sm text-zinc-700 dark:text-white' href='product-detail.html'>
                      تیشرت اسپورت مردانه
                    </a>
                    <!-- Product Attribute -->
                    <div
                      class="flex items-center gap-x-2 text-xs text-zinc-500 dark:text-gray-300"
                    >
                      <div>تعداد : 2</div>
                      <div
                        class="h-3 w-px rounded-full bg-gray-200 dark:bg-white/5"
                    ...
                    <div class="flex items-center justify-between gap-x-2">
                      ...
                      <div class="text-emerald-500 dark:text-emerald-400">
                        <span class="font-bold">1,800,000</span>
                        <span class="text-xs">تومان</span>
                      </div>
                      <!-- Product Quantity -->
                      <div
                        class="flex h-8 w-20 justify-between rounded-lg border border-gray-100 px-2 py-1 dark:border-white/5"
                      >
                        ...
                        <input
                          ...
                          disabled
                          type="number"
                          class="flex h-5 w-5 w-full select-none items-center justify-center bg-transparent text-center text-sm text-zinc-700 outline-none dark:text-white"
                        />
                        <button type="button" data-action="decrement">
                          <svg class="h-5 w-5 text-red-600 dark:text-red-500">
                            <use xlink:href="#minus" />
                          </svg>
                        </button>
                      </div>
          ...
          <div
            class="sticky bottom-0 left-0 right-0 flex items-center justify-between border-t border-gray-100 p-4 px-6 py-4 dark:border-white/5"
          >
            <div class="flex flex-col items-center gap-y-1">
              <div class="text-sm text-zinc-500 dark:text-zinc-400">
                مبلغ قابل پرداخت
            ...
            <a class='btn-primary w-32 py-3 text-sm' href='checkout-cart.html'>
              مشاهده سبد خرید
            </a>
          </div>
        </div>
      ...
      <!-- Color Effect -->
      <div
        class="fixed inset-x-0 top-1/3 mx-auto h-1/3 w-1/4 bg-emerald-500/50 blur-[200px] dark:bg-emerald-400/50"
      ></div>
                  ...
                  <div class="swiper-slide">
                    <a href="#">
                      <img
                        alt=""
                        class="max-h-[450px]"
                        src="assets/images/banners/main-slider-1.jpg"
                      />
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#">
                      <img
                        alt=""
                        class="max-h-[450px]"
                        src="assets/images/banners/main-slider-2.jpg"
                      />
                    </a>
                  </div>
                  <div class="swiper-slide">
                    <a href="#">
                      <img
                        alt=""
                        class="max-h-[450px]"
                        src="assets/images/banners/main-slider-3.jpg"
                      />
                    </a>
                  </div>
                </div>
                ...
                <div>
                  <a href="#">
                    <img
                      ...
                      src="assets/images/banners/main-banner-top.jpg"
                    />
                  </a>
                </div>
                ...
                <div>
                  <a href="#">
                    <img
                      alt=""
                      class="rounded-lg shadow-base"
                      src="assets/images/banners/main-bot.gif"
                    />
                  </a>
                </div>
              </div>
        ...
        <section class="mb-8">
          <div class="container relative">
            ...
            <div class="mb-4 flex items-center justify-between">
              ...
              <a class='flex items-center gap-x-2 py-2 text-sm text-emerald-500 dark:text-emerald-400 lg:text-base' href='shop.html'>
                مشاهده همه
                <span>
                      ...
                      <div class="mb-2 md:mb-5" draggable="false">
                        <a href='product-detail.html'>
                          <img
                            ...
                            src="assets/images/products/p8.png"
                          />
                        </a>
                      </div>
                      <!-- title -->
                      <div class="mb-2">
                        <a class='line-clamp-2 h-10 text-sm text-zinc-700 dark:text-white md:h-12 md:text-base' href='product-detail.html'>
                      ...
                      <div class="mb-2 md:mb-5" draggable="false">
                        <a href='product-detail.html'>
                          <img
                            alt=""
                            class="mx-auto w-32 rounded-lg md:w-auto"
                            src="assets/images/products/p7.png"
                          />
                        </a>
                      </div>
                      <!-- title -->
            ...
            <div class="flex w-full flex-col justify-between gap-4 md:flex-row">
              <a href="#">
                <img
                  alt=""
                  class="rounded-base"
                  src="assets/images/banners/category-right.jpg"
                />
              </a>
              <a href="#">
                <img
                  alt=""
                  class="rounded-base"
                  src="assets/images/banners/category-left.jpg"
                />
              </a>
            </div>
          </div>
        ...
        <section class="mb-8">
          <div class="container relative">
            ...
            >
              ...
              <a class='relative flex w-25 flex-col items-center justify-between gap-y-1.5 sm:w-auto sm:gap-y-2.5' href='shop.html'>
                <div
                ...
                >
                  <img
                    ...
                    src="assets/images/categories/c1.jpg"
                  />
                </div>
                <p
              ...
              <a class='relative flex w-25 flex-col items-center justify-between gap-y-1.5 sm:w-auto sm:gap-y-2.5' href='shop.html'>
                ...
                >
                  <img
                    alt=""
                    class="relative h-25 w-25 rounded-full"
                    src="assets/images/categories/c3.jpg"
                  />
                </div>
                <p
                  class="line-clamp-2 h-10 text-center text-sm text-zinc-700 dark:text-white sm:text-base"
              ...
              <a class='relative flex w-25 flex-col items-center justify-between gap-y-1.5 sm:w-auto sm:gap-y-2.5' href='shop.html'>
                ...
                >
                  <img
                    alt=""
                    class="relative h-25 w-25 rounded-full"
                    src="assets/images/categories/c6.jpg"
                  />
                </div>
                <p
                  class="line-clamp-2 h-10 text-center text-sm text-zinc-700 dark:text-white sm:text-base"
              ...
              <a class='relative flex w-25 flex-col items-center justify-between gap-y-1.5 sm:w-auto sm:gap-y-2.5' href='shop.html'>
                ...
                >
                  <img
                    alt=""
                    class="relative h-25 w-25 rounded-full"
                    src="assets/images/categories/c2.jpg"
                  />
                </div>
                <p
                  class="line-clamp-2 h-10 text-center text-sm text-zinc-700 dark:text-white sm:text-base"
              ...
              <a class='relative flex w-25 flex-col items-center justify-between gap-y-1.5 sm:w-auto sm:gap-y-2.5' href='shop.html'>
                ...
                >
                  <img
                    alt=""
                    class="relative h-25 w-25 rounded-full"
                    src="assets/images/categories/c4.jpg"
                  />
                </div>
                <p
                  class="line-clamp-2 h-10 text-center text-sm text-zinc-700 dark:text-white sm:text-base"
              ...
              <a class='relative flex w-25 flex-col items-center justify-between gap-y-1.5 sm:w-auto sm:gap-y-2.5' href='shop.html'>
                ...
                >
                  <img
                    alt=""
                    class="relative h-25 w-25 rounded-full"
                    src="assets/images/categories/c5.jpg"
                  />
                </div>
                <p
                  class="line-clamp-2 h-10 text-center text-sm text-zinc-700 dark:text-white sm:text-base"
      ...
      <footer
        class="relative border-t border-gray-100 bg-white dark:border-white/5 dark:bg-zinc-900"
      >
        <!-- Footer Logo -->
        <div class="absolute inset-x-0 -top-3 flex items-center justify-center">
          <div class="relative flex h-10 w-14 justify-center">
            <div
              class="absolute inset-0 -top-[2px] h-full w-full rounded-full bg-white blur-[6px] dark:bg-zinc-900"
            ></div>
        ...
        <div class="container">
          <!-- Contact - Go to Top -->
          <div
            class="mt-10 flex flex-col items-center justify-between gap-y-4 md:flex-row"
          >
            <div
              class="flex flex-col items-center gap-x-4 gap-y-4 text-sm text-zinc-500 dark:text-zinc-300 md:flex-row"
            >
              <p>تلفن پشتیبانی 0000000 - 021</p>
              <span
                class="hidden h-4 w-px rounded-full bg-gray-200 dark:bg-white/20 md:block"
              ></span>
              <p>۷ روز هفته، ۲۴ ساعته پاسخگوی شما هستیم</p>
            </div>
            <div class="order-first flex md:order-last">
              <button
                class="inline-flex items-center gap-x-2 rounded-lg border border-gray-200 p-2 text-sm text-zinc-700 hover:bg-gray-200/20 dark:border-white/5 dark:text-white dark:hover:bg-white/5"
          ...
          <div
            class="relative mb-10 mt-10 flex flex-col items-center justify-between gap-x-4 gap-y-8 rounded-xl bg-gray-100 px-10 py-4 shadow-base backdrop-blur-3xl dark:bg-black md:flex-row"
          >
            <div>
            ...
            <div class="w-full flex-1 flex-grow md:max-w-lg">
              <div
                class="flex w-full items-center justify-between gap-x-2 rounded-lg bg-white dark:bg-zinc-900"
              >
                ...
                <input
                  ...
                  autocomplete="off"
                  class="w-full border-none bg-transparent px-4 py-2.5 text-right text-zinc-600 outline-none placeholder:text-right placeholder:text-sm placeholder:text-zinc-500 focus:outline-none focus:ring-0 dark:text-zinc-300 placeholder:dark:text-zinc-400"
                  dir="ltr"
                  id="emailInput"
            ...
            <div class="flex items-center justify-center gap-x-10 md:gap-x-6">
              <div
                class="text-zinc-700 transition-colors duration-200 hover:text-rose-600 dark:text-white hover:dark:text-rose-500"
              >
              ...
              <div
                class="text-zinc-700 transition-colors duration-200 hover:text-blue-600 dark:text-white hover:dark:text-blue-500"
              >
              ...
              <div
                class="text-zinc-700 transition-colors duration-200 hover:text-red-600 dark:text-white hover:dark:text-red-500"
              >
          ...
          <div class="grid grid-cols-12 gap-y-10">
            <div class="col-span-12 md:col-span-6">
              <div
                class="grid grid-cols-12 justify-items-center md:justify-items-start"
              >
                <div class="col-span-6 flex flex-col gap-y-6">
                  <p class="select-none text-lg text-zinc-700 dark:text-white">
                    روتی کالا
                  </p>
                  <ul class="space-y-4 text-zinc-500 dark:text-zinc-300">
                    <li>
                      <a
                        class="py-2 hover:text-emerald-500 hover:dark:text-emerald-400"
                        href="return-terms.html"
                      >
                        شرایط مرجوعی
                      </a>
                    </li>
            ...
            <div
              class="col-span-12 flex items-center justify-center gap-x-2 md:col-span-6 md:justify-end"
            >
              <a href="#" class="relative">
                <img
                  alt="namad"
                  class="h-[130px] w-[130px] blur-sm"
                  src="assets/images/namad.png"
                />
                <!-- Delete This -->
                <span
                  class="absolute inset-x-0 top-0 mx-auto w-fit rounded-lg bg-red-500 px-4 py-2 text-white dark:bg-red-600"
                >
                  تستی
                </span>
              </a>
          ...
          <!-- Copyright -->
          <div
            class="mt-4 flex items-center justify-center border-t border-gray-100 py-4 dark:border-white/5"
          >
            <p class="text-xs text-zinc-500 dark:text-zinc-400 xs:text-sm">
...
<!-- Mirrored from roti-preview.taymakz.ir/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2024 09:56:20 GMT -->
</html>
