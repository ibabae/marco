...
<html class="no-js" lang="fa" dir="rtl">
    <head>
        <meta charset="utf-8"/>
        <title>@if(Route::is('home')){{Setting('title')}}@else @if(isset($title)) {{$title}} @else {{Setting('title')}} @endif @endif</title>
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <meta http-equiv="x-ua-compatible" content="ie=edge"/>
        <meta name="description" content="@if(isset($descriptions)){{$descriptions}}@endif"/>
                                ...
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        <figure class="border-radius-10">
                                            <img src="{{asset('/assets/imgs/shop/product-1-1.jpg')}}" alt="product image">
                                        </figure>
                                        <figure class="border-radius-10">
                                            <img src="{{asset('/assets/imgs/shop/product-1-1.jpg')}}" alt="product image">
                                        </figure>
                                    ...
                                    <div class="slider-nav-thumbnails pl-15 pr-15">
                                        <div><img src="{{asset('/assets/imgs/shop/product-1-1.jpg')}}" alt="product image"></div>
                                        <div><img src="{{asset('/assets/imgs/shop/product-1-1.jpg')}}" alt="product image"></div>
                                        <div><img src="{{asset('/assets/imgs/shop/product-1-1.jpg')}}" alt="product image"></div>
                                        <div><img src="{{asset('/assets/imgs/shop/product-1-1.jpg')}}" alt="product image"></div>
                                        <div><img src="{{asset('/assets/imgs/shop/product-1-1.jpg')}}" alt="product image"></div>
