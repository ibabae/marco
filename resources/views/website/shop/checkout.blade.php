                        ...
                        <div id="address-box">
                            @foreach ($addresses as $address)
                                <div class="custome-radio">
                                    <input class="form-check-input" type="radio" name="address" value="{{$address->id}}" id="address-{{$address->id}}" @if($address->primary){{'checked'}}@endif>
                                    <label class="form-check-label" for="address-{{$address->id}}" data-bs-toggle="collapse" data-target="#address-{{$address->id}}" aria-controls="{{$address->id}}">{{$address->State->name.' - '.$address->City->name.' - '.$address->address . ($address->number != null ? ' پلاک '.$address->number : '').($address->zipcode != null ? ' - کدپستی '.$address->zipcode : '')}}</label>
