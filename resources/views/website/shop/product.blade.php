                                ...
                                <div class="detail-info">
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            @if($product->disPrice)
                                                <ins><span class="old-price font-md ms-15 text-danger">{{price($product->price)}}</span></ins>
                                                <ins><span class="text-success">{{price($product->disPrice)}}</span></ins>
                                                <span class="save-price  font-md color3 ms-15"> 0% تخفیف</span>
                                            @else
                                    ...
                                    <div class="detail-extralink">
                                        ...
                                        <div class="product-extra-link2">
                                            ...
                                            <button class="btn border-primary bg-primary btn-sm button-full" data-id="{{$product->id}}">خرید سری کامل</button>
