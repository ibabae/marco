...
<!-- Mirrored from v3dboy.ir/previews/html/nextable/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 10:47:27 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="navigation">
		...
		<div class="navigation-menu-body">
			...
			<ul id="navigationApps" @if(Route::is('admin.products') OR Route::is('admin.product.create'))class="navigation-active"@endif>
			...
			<div class="header-body-right">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
							<div class="p-4 text-center" data-backround-image="{{asset('admin-assets/media/image/image1.png')}}">
